...
describe('shared/components/Waiver/index', () => {
  ...
  it('should render Waiver correctly', () => {
    ...
    expect(waiver.find('h3.sectionTitle').length).toEqual(1);
  ...
  it('should render waiver item correctly', () => {
    const titleIcon = component.find('h3.sectionTitle').find('i').at(0);
    titleIcon.simulate('click');
    expect(waiver.find('div.u-hidden').length).toEqual(1);
