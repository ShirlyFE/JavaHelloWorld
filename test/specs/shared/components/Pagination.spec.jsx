...
describe('shared => components => Pagination', () => {
  it('should rendered correctly invalid data', () => {
    ...
    expect(wrapper.find('div.aaui-pagination').exists()).toBeTruthy();
    expect(wrapper.find('a.aaui-pagination-page').exists()).toBeFalsy();
  ...
  it('should rendered correctly with different theme', () => {
    ...
    expect(wrapper.find('div.aaui-pagination').exists()).toBeTruthy();
    expect(wrapper.find('div.aaui-pagination-theme-b').exists()).toBeTruthy();
