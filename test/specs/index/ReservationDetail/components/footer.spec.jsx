...
describe('index -> ReservationDetail -> components -> Footer', () => {
  it('should render correctly with using correct permit detail changed', () => {
    ...
    expect(AlertComponent.html().indexOf('If you continue, no changes will be saved. Are you sure you want to cancel it?') > -1).toEqual(true);
    ...
    expect(AlertComponent.html().indexOf('Leave to payment plan') > -1).toEqual(true);
