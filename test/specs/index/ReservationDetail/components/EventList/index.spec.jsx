...
describe('index -> ReservationDetail -> components -> EventList', () => {
  ...
  it('component should render correctly', () => {
    ...
    expect(component.find('div.addEventIcon')).toHaveLength(1);
    expect(component.find('span.addTxt')).toHaveLength(1);
    expect(component.find('div.eventWraper')).toHaveLength(5);
    expect(component.find('i.icon-chevron-up')).toHaveLength(2);
    expect(component.find('i.icon-chevron-down')).toHaveLength(9);
    ...
    expect(component.find(Alert)).toHaveLength(6);
  ...
  it('component should render correctly if no authority', () => {
    ...
    expect(component.find('div.eventList')).toHaveLength(1);
    expect(component.find('div.addEventIcon')).toHaveLength(1);
    expect(component.find('span.addTxt')).toHaveLength(0);
    expect(component.find('div.eventWraper')).toHaveLength(5);
    expect(component.find('i.icon-chevron-up')).toHaveLength(2);
    expect(component.find('i.icon-chevron-down')).toHaveLength(9);
  ...
  it('component should work fine', () => {
    ...
    resetActions();
    const addEventBtn = component.find('span.addTxt');
    ...
    resetActions();
    const expandEventBtns = component.find('i.icon-chevron-down');
    ...
    resetActions();
    deleteEventBtns.at(0).simulate('click');
    deleteAlert.find('span.modal-close').simulate('click');
    setTimeout(() => {
      expect(deleteAlert.find('div.is-open')).toHaveLength(0);
      expect(instance.cache).toEqual({});
    }, 2000);
