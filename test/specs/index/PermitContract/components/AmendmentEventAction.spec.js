...
it('AmendmentEventAction of add event action should render without errors', () => {
  ...
  expect(addEventCell.find('.event-header-note').text()).toEqual('Event Notes: Lorem ipsum dolor sit amet, consectetur adipiscing elit.');
...
it('AmendmentEventAction of edit event action should render without errors', () => {
  ...
  expect(addEventCell.find('.event-header-note').at(1).text()).toEqual('Event Notes: ABCDEFGHIJKLMNOPQRSTUVWXYZ');
