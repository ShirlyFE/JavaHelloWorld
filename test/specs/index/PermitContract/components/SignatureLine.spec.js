...
it('SignatureLine should render company customer without errors', () => {
  ...
  expect(signatureContainers).toHaveLength(3);
  ...
  const additionalCustomerSignatureContainer = signatureContainers.at(2);
  expect(additionalCustomerSignatureContainer).toEqual(companySignatureContainer.find('.signature-container-additional'));
