...
describe('index -> Resource -> utils -> recurring', () => {
  ...
  it('Returns updated base booking for recurring booking', () => {
    ...
    const updatedBaseBooking3 = newState3.getIn(bookingsPath).get(1).toJS();
    expect(updatedBaseBooking3.hasRecurring).toBeFalsy();
    expect(updatedBaseBooking3.recurringEnabled).toBeTruthy();
    expect(updatedBaseBooking3.pendingRemoveFromRecurringGroup).toEqual('');
  });
