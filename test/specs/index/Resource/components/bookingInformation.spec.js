...
describe('index/Resource/components/BookingInformation', () => {
  ...
  it('BookingInformation should render without errors', () => {
    ...
    component.find('.clear-all').simulate('click');
  ...
  it('render identifier correctly', () => {
    ...
    expect(wrapper.find('.header__title > span').text()).toBe('- Customer Name');
    ...
    expect(wrapper.find('.header__title > span').text()).toBe('- Company Name');
    ...
    expect(wrapper.find('.header__title > span').text()).toBe('- Company Name (R123)');
    ...
    expect(wrapper.find('.header__title > span').text()).toBe('- R123');
