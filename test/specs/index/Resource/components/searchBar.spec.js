...
const searchSectionData = { showSearchBar: true, fixedSearchBar: false };
...
const props = {
  filters: filtersData,
  searchSection: fromJS(searchSectionData),
...
it('The SearchBar fixedSearchBar equal to false render without error', () => {
  const newSearchSectionData = { showSearchBar: true, fixedSearchBar: false };
  ...
  const nextProps = Object.assign(
    ...
    { searchSection: fromJS(newSearchSectionData) }
  );
